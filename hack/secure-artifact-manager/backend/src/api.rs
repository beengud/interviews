...
#[get("/artifacts")]
pub async fn list_artifacts() -> impl Responder {
...
#[post("/upload")]
pub async fn upload_artifact(mut payload: Multipart) -> impl Responder {
...
#[get("/download/{id}")]
pub async fn download_artifact(path: web::Path<String>) -> actix_web::Result<NamedFile> {
