...
High-level architecture of the Secure Artifact Manager:
...
#### [L2] Resource organization (namespaces, labels, etc.)
...
#### [L2] Basic deployment manifests approach
...
#### [L2] ConfigMap and Secret management
...
#### [L2] Resource limits and requests
...
#### [L3] Component deployments and their relationships
...
#### [L3] Service definitions and networking approach
...
#### [L3] Storage requirements and persistent volume strategy
...
#### [L3] Ingress configuration and TLS

- NGINX ingress controller
- TLS using cert-manager with Let's Encrypt

#### [L3] Deployment method (scripts, Helm charts, etc.)
...
#### [L4] GitOps implementation details
...
#### [L4] Monitoring and observability setup
...
#### [L4] Backup and recovery strategy
...
**TODO:** need more research and clarification here
...
- **TODO**: user RBAC roles
- **TODO**: audit logging and download authorization
...
- (**TODO:** get clarification) Compliance reporting and attestations
...
- Kubernetes:
  ...
  - (**TODO:** get clarification)Custom admission controllers for security
  - Backup and disaster recovery strategy
    - init velero (**TODO:** need to read more on using velero, unsure of scope)
...
**TODO:** section is wip, ask for clarification
...
- (**TODO: get clarification**) Advanced Kubernetes features usage
  - HPA for autoscaling?
...
- Monitoring and observability
  ...
  - Use Mimir instead of prometheus, and leverage multi-tenant features of mimir and loki to enhance security and query performance
    - e.g. users are in organizations, organizations are tenants, users queries are automatically restricted to their tenant
      - admin still able to perform cross-tenant queries
